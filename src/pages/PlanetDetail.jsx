                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        >
                            <motion.div
                                ...
                                className={`w-64 h-64 md:w-96 md:h-96 rounded-full ${!planet.img ? `bg-gradient-to-br ${planet.color}` : ''} ${planet.glow} shadow-2xl mb-8 relative flex items-center justify-center`}
                            >
                                {planet.img ? (
                                    <img
                                        src={planet.img}
                            ...
                            <div className="glass p-6 rounded-xl text-center w-full max-w-md">
                                <h3 className="text-saffron uppercase tracking-widest text-sm mb-2">Vedic Mantra</h3>
                                <p className="font-serif italic text-lg leading-relaxed text-gold">"{planet.mantra}"</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div>
                                <h1 className="text-4xl md:text-6xl font-serif font-bold text-white mb-2">{planet.name}</h1>
                                <h2 className="text-2xl text-white/50">{planet.englishName}</h2>
                            </div>

                            <p className="text-lg text-white/80 leading-relaxed border-l-2 border-gold/50 pl-4">
                                {planet.description}
                            </p>

                            <div>
                                <h3 className="text-xl font-serif text-white mb-4 flex items-center gap-2">
                                    <Star className="text-gold" size={20} /> Controls
                                </h3>
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="bg-emerald-900/20 border border-emerald-500/20 p-5 rounded-xl">
                                    <h3 className="text-emerald-400 font-serif mb-3 flex items-center gap-2">
                                ...
                                <div className="bg-red-900/20 border border-red-500/20 p-5 rounded-xl">
                                    <h3 className="text-red-400 font-serif mb-3 flex items-center gap-2">
                                ...
                                <div className="space-y-3">
                                    {planet.remedies.map((r, i) => (
                                        <div key={i} className="flex items-start gap-3 p-3 glass rounded-lg hover:bg-white/10 transition-colors">
                                            <div className="w-6 h-6 rounded-full bg-gold/20 flex items-center justify-center text-xs text-gold font-bold mt-0.5">
                                                {i + 1}
                                            </div>
