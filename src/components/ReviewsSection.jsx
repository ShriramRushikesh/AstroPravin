                    ...
                    {reviews.map((review, i) => (
                        ...
                        >
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gold to-saffron flex items-center justify-center text-black font-bold">
                                    {review.name[0]}
                                </div>
                                <div>
                                    <h4 className="text-white font-bold group-hover:text-gold transition-colors">{review.name}</h4>
