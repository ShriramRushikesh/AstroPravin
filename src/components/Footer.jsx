                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <p className="leading-relaxed mb-6">
                            <span className="text-white font-serif text-lg mb-6">AstroPravin</span> is the official online platform of <span className="text-gradient-primary"><strong>Shriram Samupdeshan Kendra</strong></span> , offering authentic Marathi Vedic astrology, kundli analysis, and personalized remedies to help people find clarity in life, career, and relationships through trusted ancient wisdom.
                        </p>
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/shriramsamupdeshankendra?igsh=MWtqdHlrcDB2MW1sZw==" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-secondary hover:text-black transition-colors"><Instagram size={28} /></a>
                            <a href="https://www.facebook.com/share/1DbV4mf9jH/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-secondary hover:text-black transition-colors"><Facebook size={28} /></a>
                            <a href="https://www.youtube.com/@PRAVINSHRIRAM-hi9zo" className="p-2 bg-white/5 rounded-full hover:bg-secondary hover:text-black transition-colors"><Youtube size={28} /></a>
                            <a href="https://jsdl.in/DT-9979FYHCSEX" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-secondary hover:text-black transition-colors font-bold text-xs flex items-center justify-center w-[44px] h-[44px]" title="Rated on Justdial" size={28}>JD</a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 mb-6">
                            <li className="flex items-start gap-3">
                                <MapPin className="mt-1 text-secondary" size={40} />
