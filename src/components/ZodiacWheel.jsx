    ...
    return (
        <div className="relative w-[300px] h-[300px] md:w-[600px] md:h-[600px] lg:w-[800px] lg:h-[800px] opacity-30 select-none pointer-events-none">
            ...
            <motion.div
                ...
                className="absolute inset-0 border-[1px] border-saffron/20 rounded-full border-dashed"
            />
            ...
            <motion.div
                ...
                className="absolute inset-10 border-[1px] border-gold/10 rounded-full flex items-center justify-center p-12"
            >
                <div className="w-full h-full border border-white/5 rounded-full relative">
                    ...
                    {[...Array(12)].map((_, i) => (
                        <div
                            key={i}
                            className="absolute w-2 h-2 bg-saffron rounded-full"
                            style={{
                                top: '50%',
                                left: '50%',
                    ...
                    <svg className="absolute inset-0 w-full h-full text-saffron/10" viewBox="0 0 100 100">
            ...
            <motion.div
                ...
                className="absolute inset-[25%] border border-gold/20 rounded-full flex items-center justify-center"
            >
                <div className="w-4 h-4 bg-gold rounded-full shadow-[0_0_20px_#FFD700]" />
            </motion.div>
        </div>
    );
};
