        ...
        <section className="relative py-20 bg-void overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        {/* Decorative Rings */}
                        <div className="absolute inset-0 border-2 border-gold/30 rounded-t-full rounded-b-[1000px] scale-110 animate-pulse-slow" />
                        <div className="absolute inset-0 border border-saffron/20 rounded-t-full rounded-b-[1000px] scale-125" />

                        <div className="relative z-10 rounded-t-full rounded-b-[200px] overflow-hidden border-b-4 border-gold shadow-[0_0_50px_rgba(255,215,0,0.2)]">
                            <img
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-6 -right-6 bg-gradient-to-br from-gold to-saffron p-6 rounded-full text-black shadow-lg z-20"
                        >
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif text-white mb-6 leading-tight">
                            Pandit <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-saffron">Pravin Shriram</span>
                        </h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {qualities.map((item, index) => (
                                <motion.div
                                    ...
                                    className="flex items-center gap-3 bg-white/5 p-3 rounded-lg border border-white/5 hover:border-gold/30 transition-colors"
                                >
